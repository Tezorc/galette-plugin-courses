...
**Badge "Conflit horaire"** : si deux de vos inscriptions — ou deux inscriptions d'une meme personne du foyer — se chevauchent le meme jour, un badge orange le signale, avec le detail au survol. C'est un **avertissement, pas un blocage** : l'inscription reste possible si vous assumez la collision.
