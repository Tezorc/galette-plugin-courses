...
galette-plugin-courses/
  ...
  scripts/upgrade-to-0.3-mysql.sql # Migration MySQL vers dbver 0.3 : valid_from/valid_to sur les creneaux (horaires saisonniers)
